...
public class AlVanquishersSecurityLambda implements RequestHandler<JSONObject, Object> {
	...
	public Object handleRequest(JSONObject input, Context context) {
			...
			StringBuilder securityDetails = AlVanquishersDAO.getInstance().getSecurity(inputValue);
	        ...
	        object.put("intentName", "SecurityDetails");
	        
	        
	        
	        JSONObject slots = new JSONObject();
	        slots.put("SecurityNumber", inputValue);
	        ...
	        message.put("content", securityDetails);
